            ...
            <div className="card mb-0">
                <div className="flex justify-content-between align-items-start gap-3">
                    <div className="min-w-0 flex-1">
                        <span className="block text-500 font-medium mb-2 text-sm line-height-3">{title}</span>
                        <div className="text-900 font-bold text-2xl xl:text-3xl line-height-2">{value}</div>
                        {subtitle ? <div className="text-600 mt-2 text-sm line-height-3">{subtitle}</div> : null}
                    </div>
